        ...
        <div className="login-container">
          ...
          <div className="form-row">
            <div className="col-login">
              <input className="form-control" placeholder="Email Address" type="text" name="email" value={email} onChange={handleChangeEmail} required/>
            </div>
            <div className="col-login">
              <input className="form-control" placeholder="Password" type="password" name="password" id="passwordInput" value={password} onChange={handleChangePassword} required/>
            ...
            <div className="login-button-contact" onClick={handleClick}>
              <button type="button" className="login-btn-theme">Login</button>
            </div>
