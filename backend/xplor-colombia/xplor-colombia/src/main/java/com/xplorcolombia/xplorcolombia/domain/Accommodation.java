...
@NamedNativeQueries({
        ...
        @NamedNativeQuery(name="Accommodation.seeAccommodationPerTripDestination", query="", resultSetMapping = "seeAccommodationPerTripDestination")
...
@SqlResultSetMappings({
        ...
        @SqlResultSetMapping(name="seeAccommodationPerTripDestination",
                classes = {
                        @ConstructorResult(
                                targetClass = AccommodationDTO.class,
                                columns = {
